...
modelo_3niveles_effgen <- lmer(effgen ~ sex + 
                        (1 | OCDE) +  # Efecto aleatorio en Nivel 3
                        (1 | CNT),  # Efecto aleatorio en Nivel 2
                        data = pisa22ict)
modelo_3niveles_effgen2 <- lmer(effgen ~ sex + 
                         (1 + sex | OCDE) +  # Pendiente aleatoria en Nivel 3
                         (1 + sex | CNT),  # Pendiente aleatoria en Nivel 2
                         data = pisa22ict)

modelo_3niveles_effspec <- lmer(effspec ~ sex + 
                        (1 | OCDE) +  # Efecto aleatorio en Nivel 3
                        (1 | CNT),  # Efecto aleatorio en Nivel 2
                        data = pisa22ict)
modelo_3niveles_effspec2 <- lmer(effspec ~ sex + 
                         (1 + sex | OCDE) +  # Pendiente aleatoria en Nivel 3
                         (1 + sex | CNT),  # Pendiente aleatoria en Nivel 2
                         data = pisa22ict)
